(function () {
  ...
  function install(frame) {
    ...
    comfortFeedbackStyle.textContent = `
      ...
      /* Reference-proportioned visual pass; state and interaction logic are unchanged. */
      .mcv-native-head-v4{height:33svh!important}
      .mcv-native-nav-v4{height:72px!important;padding:14px 4% 8px!important;grid-template-columns:44px minmax(0,1fr) 44px!important}
      .mcv-native-nav-v4 h2{font-size:16px!important}
      .mcv-native-icon-button-v4,.mcv-native-tools-v4{width:44px!important;height:44px!important}
      .mcv-native-device-v4{left:4%!important;right:4%!important;top:126px!important;bottom:14px!important}
      .mcv-native-pump-v4{transform:scale(.5)!important}
      .mcv-page-content{margin:0 4%!important;padding:14px 0 calc(96px + env(safe-area-inset-bottom,0px))!important;gap:14px!important}
      .mcv-control-panel{gap:14px!important}
      .mcv-mode-card{height:clamp(140px,18svh,154px)!important;min-height:clamp(140px,18svh,154px)!important;flex-basis:clamp(140px,18svh,154px)!important;padding:18px 20px!important}
      .mcv-rhythm-options-v6{gap:8px!important;margin-top:16px!important}
      .mcv-rhythm-options-v6 button{height:40px!important;padding:0 7px!important;gap:5px!important;font-size:10.5px!important}
      .mcv-rhythm-icon-v6{width:17px!important;height:17px!important}
      .mcv-level-module{height:clamp(300px,37svh,330px)!important;min-height:clamp(300px,37svh,330px)!important;flex-basis:clamp(300px,37svh,330px)!important}
      body[data-mcz-comfort-hidden] .mcv-level-module,body:has(#startPumping:not([hidden])) .mcv-level-module,body:has(.mcv-rhythm-options-v6 [data-rhythm="Stimulation"].is-active) .mcv-level-module,body:has(.mcv-rhythm-options-v6 [data-rhythm="Mixed"].is-active) .mcv-level-module{height:clamp(210px,27svh,240px)!important;min-height:clamp(210px,27svh,240px)!important;flex-basis:clamp(210px,27svh,240px)!important}
      .mcv-level-module .reference-level-chip{width:64px!important;height:36px!important;font-size:14px!important}
      .mcv-level-module .mcv-level-rail{width:58px!important}
      .mcv-level-module .mcv-sync-rail{width:68px!important}
      .mcv-bottom-shell{left:4%!important;right:4%!important;bottom:12px!important}
      .mcv-control-actions{gap:12px!important}
      .mcv-control-actions .pause-button{flex-basis:58px!important;width:58px!important;height:58px!important}
      .mcv-control-actions .reference-start,.mcv-control-actions .hold-button{height:58px!important}
      @media(max-width:360px){.mcv-native-device-v4{top:116px!important}.mcv-mode-card{padding:16px!important}.mcv-rhythm-options-v6 button{padding:0 5px!important;font-size:10px!important}.mcv-card-tertiary-v5{width:92px;min-width:92px}}
